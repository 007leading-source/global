...
/* 🔥 SEND WITHOUT ITEMS FIRST */
const res=await fetch(API+`?action=createSale&CustomerID=${customerSelect.value}&Subtotal=${subtotal.innerText}&Discount=${discount.value||0}&IVA=${iva.innerText}&Total=${total.innerText}`);

const data=await res.json();

/* ALWAYS USE LOCAL CART FOR PDF */
